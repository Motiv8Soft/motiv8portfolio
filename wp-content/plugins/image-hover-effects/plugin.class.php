				...
				<?php foreach ($data['allcapImages'] as $key => $data2) { ?>   
				        ...
				        <div>
							...
							<table class="form-table">
								...
								<tr>
								    <td>
								        <strong><?php _e( 'Show Title Over Image (PRO Feature)', 'la-captionhover' ); ?></strong>
								    </td>
								    <td>
								        <select class="headoverimage form-control">
								            <option value="yes"><?php _e( 'Yes', 'la-captionhover' ); ?></option>
								            <option value="no"><?php _e( 'No', 'la-captionhover' ); ?></option>
								        </select>
								    </td>
								    <td>
								        <p class="description"><?php _e( 'Select you want to show title over image before hover.', 'la-captionhover' ); ?></p>
								    </td>
								</tr>
								<tr class="titlepostion-row"> 
								    <td> 
								        <strong><?php _e( 'Title Position On Image (PRO Feature)', 'la-captionhover' ); ?></strong>
								    </td>
								    <td>
								        <select class="titlepostion form-control">
								            <option value="0%">
								                <?php _e( 'Top', 'la-captionhover' ); ?>        
								            </option>
								            <option value="50%">
								                <?php _e( 'Middle', 'la-captionhover' ); ?>        
								            </option>
								            <option value="90%">
								                <?php _e( 'Bottom', 'la-captionhover' ); ?>        
								            </option>
								        </select>
								    </td>   
								    <td>
								        <p class="description"><?php _e( 'Select postion for the static title over image.', 'la-captionhover' ); ?></p>
								    </td>
								</tr>
								<tr>
									<td>
